...
- **Instance settings** - board settings, live-editable policy (concurrency, timeouts, protected paths), and a Connections screen with a one-click reachability check for the gateway, forge and reviewing model
